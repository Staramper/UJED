...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar navbar-dark bg-dark navbar-expand-md fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                    <img src="/img/logo/ujed_logo.png" width="50" alt="Logo">
            </a>
    ...
    <!-- INICIO -->
    <div id="ujed" class="container-fluid d-flex justify-content-center align-items-center min-vh-100 bg-warningx">
            <div class="row">
                <div id="difuminado" class="col text-center">
                    <p class="text-white fw-bold" id="title">UJED</p>
                    <p class="text-white fst-italic">Facultad de ciencias exactas</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <p class="m-0">UJED | Copyright @ {{ date('Y') }}</p>
        </div>
        </footer>    
